...
"stylesheet");const l=this.getAttribute("id"),q=function(){const t=k.styleSheets;let n=!1;for(let r=t.length-1;-1<r;--r)if(t[r].ownerNode.id===l){n=!0;break}if(!0===n){if(f&&f(),e.cssCallbacks[l]){for(let r=0,u=e.cssCallbacks[l].length;r<u;++r)e.cssCallbacks[l][r]();delete e.cssCallbacks[l]}}else setTimeout(q,80)};(f||e.cssCallbacks[l]!==p)&&q()};if(-1===c.indexOf("http")){const l=k.createElement("a");l.href=c;c=l.href}a.setAttribute("href",c);a.setAttribute("rel","prefetch");a.setAttribute("as",
"style");a.setAttribute("importance","low");a.setAttribute("media",d);a.setAttribute("id",g);if("isApplicationInstalled"in navigator)a.onloadcssdefined(h);else a.addEventListener("load",h,{passive:!0,once:!0});g=b;g||(g=(g=k.getElementById("tf_lazy_common"))?g.nextSibling:k.head.firstElementChild);g.parentNode.insertBefore(a,b?g:g.nextSibling)},InitGallery(){var a=!1===this.is_builder_active&&themify_vars.lightbox?themify_vars.lightbox:!1;if(!1!==a&&!1!==a.lightboxOn&&this.jsLazy.tf_gallery_init===
p){this.jsLazy.tf_gallery_init=!0;const c=this,b=m.location.hash.replace("#",""),d=c.body.parent(),f={extraLightboxArgs:themify_vars.extraLightboxArgs,lightboxSelector:a.lightboxSelector?a.lightboxSelector:".themify_lightbox",gallerySelector:a.gallerySelector?a.gallerySelector:".gallery-item a",contentImagesAreas:a.contentImagesAreas,i18n:a.i18n?a.i18n:[]};a.disable_sharing&&(f.disableSharing=a.disable_sharing);let g=!1;const e=function(l){return l.match(/\.(gif|jpg|jpeg|tiff|png|webp|apng)(\?fit=\d+(,|%2C)\d+)?(&ssl=\d+)?$/i)},
h=function(l){l.preventDefault();l.stopImmediatePropagation();if(!0!==g){g=!0;var q=w(l.currentTarget);l=q[0].getAttribute("href");var t=k.createElement("div"),n=k.createElement("div"),r=function(){!0===c.cssLazy.tf_lightbox&&!0===c.jsLazy.tf_lightbox&&!0===c.jsLazy.tf_gallery&&(d.off("click.tf_gallery"),c.trigger("tf_gallery_init",f),q.click(),t.remove())};t.className="tf_lazy_lightbox tf_w tf_h";l&&e(l)?(t.textContent="Loading...",n=new Image,n.decoding="async",n.src=l):(n.className="tf_lazy tf_w tf_h",
t.appendChild(n));c.body[0].appendChild(t);c.cssLazy.tf_lightbox||c.LoadCss(c.css_modules.lb,null,null,null,function(){c.cssLazy.tf_lightbox=!0;r()});c.jsLazy.tf_lightbox||c.LoadAsync(c.js_modules.lb,function(){c.jsLazy.tf_lightbox=!0;r()},"1.1.0",null,function(){return"undefined"!==typeof w.fn.magnificPopup});c.jsLazy.tf_gallery||c.LoadAsync(c.js_modules.gal,function(){c.jsLazy.tf_gallery=!0;r()},null,null,function(){return!!c.jsLazy.tf_gallery});r()}};d.on("click.tf_gallery",f.lightboxSelector,
h);if(f.gallerySelector)d.on("click.tf_gallery",f.gallerySelector,function(l){e(this.getAttribute("href"))&&!this.closest(".module-gallery")&&h(l)});if(a.contentImagesAreas)d.on("click.tf_gallery",".post-content a",function(l){e(this.getAttribute("href"))&&w(this).closest(f.contentImagesAreas)&&h(l)});b&&"#"!==b&&(a=k.querySelector('img[alt="'+decodeURI(b)+'"]'),(a=null===a?k.querySelector('img[title="'+decodeURI(b)+'"]'):a)&&(a=a.closest(".themify_lightbox"))&&a.click())}},parseVideo(a){a=a.match(/(http:|https:|)\/\/(player.|www.)?(vimeo\.com|youtu(be\.com|\.be|be\.googleapis\.com))\/(video\/|embed\/|watch\?v=|v\/)?([A-Za-z0-9._%-]*)(&\S+)?/i);
